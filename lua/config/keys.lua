...
if has_telescope then
  ...
  set('n', '<leader>ff', ts.find_files, { desc = 'Find files' })
  set('n', '<C-p>', ts.find_files, { desc = 'Find files' })
  set('n', '<leader>fg', ts.live_grep, { desc = 'Live grep' })
  set('n', '<leader>fh', ts.help_tags, { desc = 'Help tags' })

  set('n', '<leader>ls', ts.lsp_document_symbols, { desc = 'Document symbols' })
  set('n', '<leader>lw', ts.lsp_workspace_symbols, { desc = 'Workspace symbols' })
end
